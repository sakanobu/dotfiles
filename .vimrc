...
" タブの操作を色々変更
" やめた､何故かというとこれ使うとステータスラインの上にタブの種類が表示されて便利だけど
" QuickFixが表示されなくなるので､それによってaleのQuickFixが表示されなくので
...
" vimの<S-k>によるカーソル上にある単語のvimのマニュアル表示を維持しつつ(filetypeで)､
" TypeScriptなどではカーソル上の単語のホバーを出すなどしてくれる!
